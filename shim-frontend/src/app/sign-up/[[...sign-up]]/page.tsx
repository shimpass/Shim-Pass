      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-12 relative overflow-hidden border-r border-white/5 bg-[#050505]">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-zinc-400 text-lg font-light leading-relaxed">
            Gain immediate access to the lowest-level browser API interception toolkit available. Defeat proctoring, disable detection, and execute your work securely.
          </p>
        </div>
